...
$(TARGET): $(SDL2_LIB) $(LIBHV_LIB) $(TINYGL_LIB) $(APP_C_OBJS) $(APP_OBJS) $(APP_MODULE_OBJS) $(OBJCPP_OBJS) $(LVGL_OBJS) $(LV_MARKDOWN_OBJS) $(THORVG_OBJS) $(FONT_OBJS) $(TRANS_OBJS) $(WPA_DEPS)
	$(Q)mkdir -p $(BIN_DIR)

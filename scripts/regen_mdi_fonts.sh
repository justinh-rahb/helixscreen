...
MDI_ICONS+=",0xF0588"    # view-grid (th-large)
...
MDI_ICONS+=",0xF072E"    # arrow-down-bold (arrow-down-to-line)
MDI_ICONS+=",0xF0737"    # arrow-up-bold (arrow-up-from-line)
...
MDI_ICONS+=",0xF097A"    # film (filament - film reel icon)

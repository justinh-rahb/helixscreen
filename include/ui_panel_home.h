...
// New code should use the HomePanel class directly.
//
...
/**
 * @deprecated Use HomePanel class directly
 * @brief Legacy wrapper - initialize home panel subjects
 */
[[deprecated("Use HomePanel class directly - see docs/PANEL_MIGRATION.md")]]
void ui_panel_home_init_subjects();

/**
 * @deprecated Use HomePanel class directly
 * @brief Legacy wrapper - setup observers after XML creation
 */
[[deprecated("Use HomePanel class directly - see docs/PANEL_MIGRATION.md")]]
...
/**
 * @deprecated Use HomePanel class directly
 * @brief Legacy wrapper - create home panel from XML
 */
[[deprecated("Use HomePanel class directly - see docs/PANEL_MIGRATION.md")]]
lv_obj_t* ui_panel_home_create(lv_obj_t* parent);

/**
 * @deprecated Use HomePanel::update() instead
 * @brief Legacy wrapper - update status and temperature
 */
[[deprecated("Use HomePanel::update() instead")]]
void ui_panel_home_update(const char* status_text, int temp);

/**
 * @deprecated Use HomePanel::set_network() instead
 * @brief Legacy wrapper - set network status
 */
[[deprecated("Use HomePanel::set_network() instead")]]
void ui_panel_home_set_network(network_type_t type);

/**
 * @deprecated Use HomePanel::set_light() instead
 * @brief Legacy wrapper - set light state
 */
[[deprecated("Use HomePanel::set_light() instead")]]
void ui_panel_home_set_light(bool is_on);

/**
 * @deprecated Use HomePanel::get_light_state() instead
 * @brief Legacy wrapper - get light state
 */
[[deprecated("Use HomePanel::get_light_state() instead")]]
